...
TEX_STATIC    = sig-alternate-05-2015.cls
TEX_GENERATED = 
...
FIGURES_STATIC    = figures/tcp-hollywood.pdf
FIGURES_GENERATED = figures/tcp-hollywood-fixed.pdf \
										figures/tcp-hollywood-tmp1.pdf \
										figures/tcp-hollywood-tmp2.pdf
...
figures/tcp-hollywood-fixed.pdf: figures/tcp-hollywood-tmp2.pdf
	gs -q -dSAFER -dNOPAUSE -dBATCH -dCompatibilityLevel=1.4 -dDetectDuplicateImages=true \
	   -dPDFSETTINGS=/prepress -dEmbedAllFonts=false -dSubsetFonts=false -sDEVICE=pdfwrite \
		 -sOutputFile=$@ -c ".setpdfwrite <</AlwaysEmbed [ ]>> setdistillerparams" -f $<

figures/tcp-hollywood-tmp2.pdf: figures/tcp-hollywood-tmp1.pdf
	gs -q -dSAFER -dNOPAUSE -dBATCH -dCompatibilityLevel=1.4 -dDetectDuplicateImages=true \
	   -dPDFSETTINGS=/prepress -dEmbedAllFonts=false -dSubsetFonts=false -sDEVICE=pdfwrite \
		 -sOutputFile=$@ -c ".setpdfwrite <</AlwaysEmbed [ ]>> setdistillerparams" -f $<

figures/tcp-hollywood-tmp1.pdf: figures/tcp-hollywood.pdf
	gs -q -dSAFER -dNOPAUSE -dBATCH -dCompatibilityLevel=1.4 -dDetectDuplicateImages=true \
	   -dPDFSETTINGS=/prepress -dEmbedAllFonts=false -dSubsetFonts=false -sDEVICE=pdfwrite \
		 -sOutputFile=$@ -c ".setpdfwrite <</AlwaysEmbed [ ]>> setdistillerparams" -f $<
