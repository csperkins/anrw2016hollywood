...
(Google report XX\% \todo{how much?} of endpoints are reachable with QUIC
running over UDP \cite{}). 
...
freedom. 
Firstly, the TCP congestion control algorithm is executed by the end
...
Then, we note that the API that is exposed to applications using TCP is
